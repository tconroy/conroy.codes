...
const sharedClassNames = 'transition-colors duration-150';
        ...
        rehypePlugins: [
          ...
          [
            addClasses,
            {
              ...
              p: 'mb-7',
              h2: 'mt-10 mb-5 dark:text-white transition-colors duration-150',
              h3: 'mt-10 mb-5 dark:text-white transition-colors duration-150',
            },
          ],
          () => (tree) => {
