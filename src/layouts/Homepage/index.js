    ...
    return (
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          <h1>
            {`Hey! I'm Tom, a Front-End Engineer based out of New York City.`}
          </h1>
          <h2>
            {`I'll help transform your product vision into beautiful experiences
            your users will`}
          ...
          <ul className={styles.socialList}>
            <li tabIndex="0" className={styles.resume}>
              <a
                ...
                title="Resume"
                target="_blank"
                href="../assets/docs/tomconroy_webdeveloper_resume_2017.pdf"
              >
